<?php echo Form::open(array( 'id' => 'question-form', 'class' => 'form-horizontal', 'name' => 'question')) ?>
	<?php echo Form::fieldset_open(array(), 'Question Properties') ?>			
		<div class="control-group ">
			...
			<div class="controls">
				<input type="text" id="title" name="question.title" class="span12" class="input-xxlarge required" required="required"/>
			</div>
		</div>
		<div class="control-group">
			<label for="description" class="control-label">Description</label>
			<div class="controls">
				<textarea type="text" id="description" name="question.description" class="span12" class="input-xxlarge" style="height: 150px;"></textarea>
			</div>
		</div>
		<div class="control-group">
			<label for="difficulty" class="control-label">Difficulty</label>
			<div class="controls">
				<?php echo Form::select('question.difficulty', null, array('easy' => 'Easy', 'medium' => 'Medium', 'hard' => 'Hard')); ?>
			</div>
		</div>
	<?php echo Form::fieldset_close() ?>
	
	<?php echo Form::fieldset_open(array(), 'Section Properties') ?>
		<div class="section-edit-container" data-section-count="0">
			
		</div>

		<div class="section-edit-controls btn-group pull-right" style="margin-top: 15px;">
			  ...
			  <ul class="dropdown-menu">
				<li>
					<table class="dropdown-table">
						<tr>
							<td><span class="add-on" style="margin-left: 20px;">Rows: </span></td>
							<td><input id="section-edit-addrows" type="text" placeholder="eg. 3" style="width: 50px"></td>
						</tr>
						<tr>
							<td><span class="add-on" style="margin-left: 20px;">Cols: </span></td>
							<td><input id="section-edit-addcols" type="text" placeholder="eg. 2" style="width: 50px"></td>
						</tr>
						<tr>
							<td></td>
							<td></td>
				...
				<li class="divider"></li>
				<li><a class="section-edit-add" href="#">Add Section</a></li>
			  </ul>
		</div>
	<?php echo Form::fieldset_close() ?>
